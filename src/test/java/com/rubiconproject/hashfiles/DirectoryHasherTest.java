...
public class DirectoryHasherTest extends AbstactHashableTest {
    ...
    public void resultEqualsExpectedHashForDirectoryAndAllItFilesTest() {
        ...
        resultEqualsExpectedHash(barDir);
        ...
        resultEqualsExpectedHash(fileA);
        ...
        resultEqualsExpectedHash(fileB);
        ...
        resultEqualsExpectedHash(fileC);
        ...
        resultEqualsExpectedHash(fazDir);
        ...
        resultEqualsExpectedHash(fileD);
        ...
        resultEqualsExpectedHash(fileE);
