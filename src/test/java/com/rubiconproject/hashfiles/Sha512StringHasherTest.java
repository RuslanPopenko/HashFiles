...
/**
 * Test class for Sha512StringHasher.
 *
...
public class Sha512StringHasherTest extends AbstactHashableTest {
    ...
    @Test
    public void expectSha512AnlgorithmOfMessageDigestInstanceExistTest() throws NoSuchAlgorithmException {
    ...
    @Test
    public void expectedAssertErrorWithMessageConstructingInstanceWithNullArgumentTest() {
    ...
    public void expectedAssertErrorWithMessageInvokingHashWithNullCharsetTest() {
        expectedAssertErrorWithMessageInvokingHashWithNullCharset(new Sha512StringHasher(testString));
    }

    @Test
    public void expectedOriginalStringGetNameOfHashableInstance() {
        super.expectedGetNameOfHashableInstance(new Sha512StringHasher(testString), testString);
    }

    @Test
    public void resultEqualsExpectedHashTest() {
        ...
        resultEqualsExpectedHash(new Sha512StringHasher(testString));
    }
}
